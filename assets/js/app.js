...
const App = {
  ...
  nav: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'media-quarterly', name: '季度报表', icon: '??' },
      ]
    },
    {
      group: '个人成长',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'system-settings', name: '设置', icon: '??' },
      ]
    }
  ],
  ...
  init() {
    ...
    if (hashPage && this.findNavItem(hashPage)) {
    ...
    window.addEventListener('hashchange', () => {
      ...
      if (page && page !== this.currentPage && this.findNavItem(page)) {
        this.navigate(page);
      }
    });
